...
use ghad_core::models::ObservedRepo;
use ghad_core::store::ObservedStore;
...
pub async fn handle_observe(args: &ObserveArgs) -> Result<()> {
    ...
    let agent = args.agent().map(|s| match s {
        "codex" => ghad_core::models::AgentType::Codex,
        "agy" => ghad_core::models::AgentType::Agy,
        "claude" => ghad_core::models::AgentType::Claude,
        "copilot" => ghad_core::models::AgentType::Copilot,
        _ => unreachable!(),
    });
