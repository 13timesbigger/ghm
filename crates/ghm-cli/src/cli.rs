...
pub enum Commands {
    ...
    /// to authenticate with the GitHub API. Your token is stored securely in the
...
pub enum AuthCommands {
    ...
    /// the GitHub Device Flow for OAuth authentication. The token is stored
    /// in ~/.config/ghm/config.toml.
    ///
